...
import { Link } from "react-router-dom";
    ...
    return(
        ...
        <div className="headLeft">
            <div className="hl1"><Link to="/teacher"><img className="headlogo" src={logo} alt="polygon" /></Link></div>
            {/* <div className="hl2">Welcome back, <span>{props.user.username}</span></div> */}
        </div>
        <div className="headRight">
        <div className="link1"></div>
            <div className="link2"><Link to="/teacher/tealeave" style={{ color: '#FFFFFF', textDecoration: 'none' }}><p>REQUESTS</p></Link></div>
